...
/**
 *
 * 解决oauth2中使用redis出现的错误: java.lang.NoSuchMethodError: org.springframework.data.redis.connection.RedisConnection.set 的错误
 * 拷贝自RedisTokenStore
 * 将 conn.set 替换成 conn.stringCommands().set
 *
 */
